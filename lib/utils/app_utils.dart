...
import '../controller/local_database/user_city_controller/user_city_controller_bloc.dart';
import '../controller/save_current_city controller/save_current_city_bloc.dart';
...
class AppUtils {
  ...
  String getWeatherIconURL(String weatherCode) {
    return AppServices.iconURL +
        weatherCode +
        AppServices.iconSize;
  }
  ...
  static void updateHomeScreenWidget(WeatherModel weatherData) {
    ...
    HomeWidget.updateWidget(
      iOSName: AppString.iOSWidgetName,
      androidName: AppString.androidWidgetName,
    );
  }
