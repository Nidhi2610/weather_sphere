...
import '../screens/saved_cities/saved_cities.dart';
import '../screens/splash_page/splash_screen_widget.dart';
...
class RouteGenerator {
  ...
  static Route<dynamic> unDefinedRoute() {
    return MaterialPageRoute(
        builder: (_) => Scaffold(
              appBar: AppBar(
                title: Text(AppString.weatherAppError),
              ),
              body: Center(
                child: Text(AppString.weatherAppRouteNotFound),
              ),
            ));
  }
